/**
 * Integration tests for WalletPortfolioPresenterV22Container
 *
...
vi.mock("@/components/wallet/variations/WalletPortfolioPresenterV22", () => {
  const MockPresenter = ({
    data,
  }: {
    data: { balance: number; currentRegime: string; isLoading: boolean };
  }) => (
    <div data-testid="v22-presenter">
...
describe("WalletPortfolioPresenterV22Container", () => {
  const createWrapper = () => {
  ...
  it("should call action handlers correctly", () => {
    ...
    render(
      <WalletPortfolioPresenterV22Container
        userId="0x123"
    ...
    expect(screen.getByTestId("v22-presenter")).toBeInTheDocument();
  });
});
