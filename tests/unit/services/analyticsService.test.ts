 ...
 * - transformBundleWallets (Pure function)
 */
...
describe("analyticsService", () => {
  ...
  describe("transformBundleWallets", () => {
    describe("Null/Undefined Input Handling", () => {
      it("should return empty array for null input", () => {
        const result = transformBundleWallets(null);

        expect(result).toEqual([]);
      });

      it("should return empty array for undefined input", () => {
        const result = transformBundleWallets(undefined);

        expect(result).toEqual([]);
      });
    });

    describe("Primary Wallet Transformation", () => {
      it("should transform primary wallet correctly", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimaryWallet",
          main_wallet: "0xMainWallet",
          visible_wallets: ["0xPrimaryWallet"],
          bundle_wallets: ["0xPrimaryWallet"],
        };
    ...
    describe("Additional Wallets Transformation", () => {
      it("should transform additional wallets with auto-generated labels", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
        ...
        expect(result[1]).toEqual({
          id: "0xWallet1",
          address: "0xWallet1",
          label: "Wallet 2", // Auto-generated: index 0 + 2
          isActive: false,
          isMain: false,
          createdAt: null,
        });
        expect(result[2]).toEqual({
          id: "0xWallet2",
          address: "0xWallet2",
          label: "Wallet 3", // Auto-generated: index 1 + 2
          isActive: false,
          isMain: false,
          createdAt: null,
        });
      ...
      it("should use custom labels when provided", () => {
        const bundleData: BundleWalletsResponse = {
          ...
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
          visible_wallets: ["0xPrimary", "0xWallet1"],
          bundle_wallets: ["0xPrimary", "0xWallet1"],
          additional_wallets: [
            {
              wallet_address: "0xWallet1",
        ...
        expect(result[1].label).toBe("Trading Wallet");
      });

      it("should handle mix of custom and auto-generated labels", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
          ...
          bundle_wallets: ["0xPrimary", "0xWallet1", "0xWallet2", "0xWallet3"],
          additional_wallets: [
            {
              wallet_address: "0xWallet1",
              label: "Trading Wallet",
        ...
        expect(result[1].label).toBe("Trading Wallet");
        expect(result[2].label).toBe("Wallet 3"); // Auto-generated
        expect(result[3].label).toBe("Savings Wallet");
      });
    });
    ...
    describe("isMain Flag Handling", () => {
      ...
      it("should set isMain to false when is_main is undefined", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
    ...
    describe("createdAt Preservation", () => {
      it("should preserve createdAt when provided", () => {
        const createdAtDate = "2025-01-15T12:00:00Z";
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
        ...
        expect(result[1].createdAt).toBe(createdAtDate);
      });

      it("should set createdAt to null when not provided", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
      ...
      it("should handle multiple wallets with different createdAt values", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
        ...
        expect(result[1].createdAt).toBe("2025-01-01T00:00:00Z");
        expect(result[2].createdAt).toBeNull();
        expect(result[3].createdAt).toBe("2025-01-15T12:00:00Z");
      });
    });

    describe("Empty Additional Wallets Array", () => {
      it("should handle empty additional_wallets array", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimaryWallet",
          main_wallet: "0xMainWallet",
      ...
      it("should handle missing additional_wallets field", () => {
        const bundleData: BundleWalletsResponse = {
          ...
          visible_wallets: ["0xPrimaryWallet"],
          bundle_wallets: ["0xPrimaryWallet"],
          // additional_wallets not provided
        };
    ...
    describe("Complex Response with Multiple Wallets", () => {
      it("should handle complex response with 5+ wallets", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
    ...
    describe("WalletAddress Interface Compliance", () => {
      it("should return objects matching WalletAddress interface", () => {
        const bundleData: BundleWalletsResponse = {
          user_id: "user123",
          primary_wallet: "0xPrimary",
          main_wallet: "0xMain",
        ...
        // Type check: ensure all required fields exist
        result.forEach((wallet: WalletAddress) => {
          ...
          expect(typeof wallet.label).toBe("string");
          expect(typeof wallet.isActive).toBe("boolean");
          expect(typeof wallet.isMain).toBe("boolean");
          expect(
            wallet.createdAt === null || typeof wallet.createdAt === "string"
          ).toBe(true);
        });
      });
    });
