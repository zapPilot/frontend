/**
 * WalletPortfolioPresenterV22 - Regime Highlighting Tests
 *
...
vi.mock("@/components/wallet/variations/v22/AnalyticsView", () => ({
  AnalyticsView: () => <div data-testid="analytics-view">Analytics View</div>,
}));

vi.mock("@/components/wallet/variations/v22/BacktestingView", () => ({
  BacktestingView: () => (
    <div data-testid="backtesting-view">Backtesting View</div>
  ),
}));

vi.mock("@/components/wallet/variations/v22/modals", () => ({
  DepositModalV3: ({ isOpen }: any) =>
    isOpen ? <div data-testid="deposit-modal">Deposit Modal</div> : null,
  RebalanceModalV18: ({ isOpen }: any) =>
    isOpen ? <div data-testid="rebalance-modal">Rebalance Modal</div> : null,
}));

vi.mock(
  "@/components/wallet/variations/v22/modals/WithdrawModalV10Dropdown",
  () => ({
    WithdrawModalV10Dropdown: ({ isOpen }: any) =>
      isOpen ? <div data-testid="withdraw-modal">Withdraw Modal</div> : null,
  })
);

vi.mock("@/components/wallet/variations/v22/WalletMenu", () => ({
...
describe("WalletPortfolioPresenterV22 - Regime Highlighting", () => {
  describe("Regime Spectrum Display", () => {
    it("should highlight Extreme Fear regime when currentRegime is 'ef'", async () => {
      ...
      render(<WalletPortfolioPresenterV22 data={mockData} />);
  ...
  describe("Data Consistency", () => {
    it("should display correct regime label dynamically in strategy explanation", async () => {
      ...
      const { unmount: unmount1 } = render(
        <WalletPortfolioPresenterV22 data={MOCK_SCENARIOS.extremeGreed} />
      );
      ...
      const { unmount: unmount2 } = render(
        <WalletPortfolioPresenterV22 data={MOCK_DATA} />
      );
      ...
      const { unmount: unmount3 } = render(
        <WalletPortfolioPresenterV22 data={neutralMockData} />
      );
      strategyCard = screen.getByTestId("strategy-card");
      await user.click(strategyCard);
    ...
    it("should show 'market sentiment is balanced' for Neutral", async () => {
      ...
      render(<WalletPortfolioPresenterV22 data={neutralMockData} />);
  ...
  describe("AnimatePresence Rendering", () => {
    it("should not render regime spectrum when strategy is collapsed", () => {
      render(<WalletPortfolioPresenterV22 data={MOCK_DATA} />);
