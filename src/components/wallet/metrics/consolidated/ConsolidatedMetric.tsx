...
/**
 * Modern consolidated metric with gradient accents and optimized layout.
 *
 * Key features:
 * - Compact padding: p-3 for reduced height
 * - Moderate fonts: text-lg/xl for ROI
 * - Left gradient accent border (green-to-emerald)
      ...
      {isROILoading ? (
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-1.5">
            <span
              className={`text-lg md:text-xl font-bold ${roiColor} tracking-tight`}
            >
