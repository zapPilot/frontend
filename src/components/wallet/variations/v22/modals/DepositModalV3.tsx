...
export function DepositModalV3({
  ...
  onClose,
  defaultChainId = 1,
  regimeAllocation: _regimeAllocation,
}: DepositModalV3Props) {
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="bg-gray-900 border border-gray-800 rounded-xl p-3 flex items-center gap-3 hover:border-gray-700 transition-colors text-left">
                            <img src={getChainLogo(selectedChain?.chainId)} className="w-8 h-8 rounded-full bg-black p-1" />
                        ...
                        <button className="bg-gray-900 border border-gray-800 rounded-xl p-3 flex items-center gap-3 hover:border-gray-700 transition-colors text-left">
                           {/* Assuming USDC for demo or dynamic token icon */}
                            ...
                            <div className="flex-1 overflow-hidden">
                                ...
                                <div className="font-bold text-gray-200 truncate">{transactionData.selectedToken?.symbol || "Select"}</div>
                            </div>
                            <ChevronDown className="w-4 h-4 text-gray-500" />
                        </button>
                    </div>
                    ...
                    <div className="relative">
                        <div className="absolute top-0 left-0 text-xs font-bold text-gray-500 uppercase tracking-wider">Amount</div>
                        <input
                            type="number"
                            value={amount}
