...
export function WalletPortfolioPresenterV21() {
      ...
      <main className="flex-1 flex justify-center p-4 md:p-8">
        <div className="w-full max-w-4xl flex flex-col gap-8 min-h-[600px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-900/40 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 flex items-center gap-6 relative overflow-hidden group">
               <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                 <PieChartIcon className="w-32 h-32 text-purple-500" />
               </div>
               
               <div className="w-20 h-20 rounded-2xl bg-gray-800 flex items-center justify-center text-3xl font-bold border border-gray-700 shadow-inner flex-shrink-0 relative z-10">
                 <span style={{ color: currentRegime.fillColor }}>{MOCK_DATA.currentRegime.toUpperCase()}</span>
               </div>
               
               <div className="relative z-10">
                 <div className="text-xs text-gray-500 font-bold uppercase tracking-widest mb-1">Current Strategy</div>
          ...
          {/* UNIFIED COMPOSITION BAR (Target vs Actual via Ghost Bars) */}
