...
import { ArrowDownCircle, ArrowUpCircle, ArrowUpRight, ChevronDown, Gauge, History, Info, LayoutDashboard, LineChart, Wallet, Zap } from "lucide-react";
      ...
      <main className="flex-1 flex justify-center p-4 md:p-8">
        <div className="w-full max-w-4xl flex flex-col gap-8 min-h-[600px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <motion.div 
              layout
              className={`bg-gray-900/40 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 relative overflow-hidden group cursor-pointer transition-colors hover:bg-gray-900/60 ${isStrategyExpanded ? 'row-span-2 md:col-span-2' : ''}`}
            ...
            >
               ...
               <motion.div layout="position" className="relative z-10 flex items-start justify-between">
                 ...
                 <div className={`p-2 rounded-full bg-gray-800 text-gray-400 transition-transform duration-300 ${isStrategyExpanded ? 'rotate-180' : ''}`}>
                 ...
                 {isStrategyExpanded && (
                   ...
                   >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                           <h4 className="text-sm font-bold text-white mb-4">Why this allocation?</h4>
                           <div className="space-y-4 text-sm text-gray-400">
                             <p>
                               In <span className="text-green-400 font-bold">Greed</span> markets, prices are high and risk is elevated.
                             </p>
                             <p>
                               Zap Pilot automatically <span className="text-white font-bold">takes profit</span> by converting volatile crypto assets into stablecoins.
                             </p>
                             <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700 mt-4">
                               <div className="flex justify-between items-center mb-2">
                                 <span>Target Crypto</span>
                                 <span className="text-white font-bold">{currentRegime.allocation.crypto}%</span>
                               </div>
                               <div className="w-full bg-gray-700 h-2 rounded-full overflow-hidden">
                                 <div className="bg-purple-500 h-full" style={{ width: `${currentRegime.allocation.crypto}%` }} />
                               </div>
                               
                               <div className="flex justify-between items-center mt-4 mb-2">
                                 <span>Target Stable</span>
                                 <span className="text-emerald-400 font-bold">{currentRegime.allocation.stable}%</span>
                               </div>
                               <div className="w-full bg-gray-700 h-2 rounded-full overflow-hidden">
                                 <div className="bg-emerald-500 h-full" style={{ width: `${currentRegime.allocation.stable}%` }} />
                               </div>
                             </div>
                           </div>
                        </div>
