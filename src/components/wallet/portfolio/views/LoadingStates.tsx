 ...
 *
 * Displays animated skeleton matching the portfolio layout structure while data loads.
 * Uses glass morphism and purple gradients consistent with the portfolio design.
 */
export function WalletPortfolioLoadingState() {
  return (
 ...
 */
export function WalletPortfolioEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4 px-4">
      {/* Empty icon */}
      <StatusIconCircle
