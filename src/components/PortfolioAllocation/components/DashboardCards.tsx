...
const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  if (isRebalanceMode) {
    // Rebalance Mode: Show before/after comparison
    return (
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-gray-500">
              ${targetCategory!.totalValue.toLocaleString()}
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-gray-500">
                ({categoryShift!.changePercentage > 0 ? "+" : ""}
                {categoryShift!.changePercentage.toFixed(1)}%)
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center space-x-2">
            <span className="text-xs text-gray-400 w-12">Current</span>
            <div className="flex-1 h-2 bg-gray-800 rounded-full overflow-hidden">
              <motion.div
                ...
                initial={{ width: 0 }}
                animate={{
                  width: `${Math.min(category.activeAllocationPercentage, 100)}%`,
                }}
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex-1 h-2 bg-gray-800 rounded-full overflow-hidden">
              <motion.div
                ...
                animate={{
                  width: `${Math.min(targetCategory!.activeAllocationPercentage, 100)}%`,
                }}
  ...
  // Normal Mode: Original card layout
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
...
const SummaryCard: React.FC<{
  ...
  rebalanceMode?: RebalanceMode;
}> = ({ includedCategories, excludedCategories, rebalanceMode }) => {
  ...
  const isRebalanceMode = rebalanceMode?.isEnabled && rebalanceMode.data;
    ...
    >
      <div className="text-center">
        <h3 className="text-lg font-semibold text-white mb-4">
          {isRebalanceMode ? "Rebalance Summary" : "Portfolio Summary"}
        </h3>

        {isRebalanceMode ? (
          // Rebalance Mode: Show rebalance statistics
          <div className="space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-400">Total to Rebalance</div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-700/50">
              ...
              <div className="space-y-2">
                {rebalanceMode
                  .data!.shifts.filter(s => s.action !== "maintain")
                  .sort(
                    (a, b) =>
                    ...
                    >
                      ...
                      <span
                        className={`font-medium ${
                          shift.action === "increase"
                            ? "text-green-400"
                            : "text-red-400"
                        }`}
                      >
                        {shift.changeAmount > 0 ? "+" : ""}
                        {shift.changeAmount.toFixed(1)}%
                      </span>
                    </div>
                  ))}
              </div>
          ...
          // Normal Mode: Show portfolio statistics
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">
