  ...
  if (!showConfirm) {
    return (
      <button
        ...
        className="w-full text-left p-4 border border-red-600/30 rounded-xl glass-morphism hover:bg-red-600/10 transition-all duration-200"
      >
    ...
    <div className="p-4 border border-red-600/50 rounded-xl bg-red-600/5">
      ...
      <div className="flex space-x-2">
        ...
        <button
          ...
          disabled={isDeleting}
          className="flex-1 px-4 py-2 rounded-xl glass-morphism hover:bg-white/10 transition-all duration-200 text-sm font-medium text-gray-300"
        >
          Cancel
        </button>
      </div>
