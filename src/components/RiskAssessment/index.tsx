 ...
 * including overall risk score, volatility metrics, and drawdown analysis
 */
      ...
      <div className="space-y-6">
        ...
        {data && !isLoading && !error && (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <VolatilityCard volatilityData={data.risk_summary.volatility} />
              <DrawdownCard drawdownData={data.risk_summary.drawdown} />
            </div>
          </>
        )}
