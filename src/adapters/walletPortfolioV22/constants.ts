/**
 * V22 Portfolio Constants
 *
 * Centralized configuration constants for V22 portfolio management.
...
import type { V22AllocationData } from "./types";
 ...
 */
export const ZERO_ALLOCATION: V22AllocationData = {
  crypto: 0,
  stable: 0,
