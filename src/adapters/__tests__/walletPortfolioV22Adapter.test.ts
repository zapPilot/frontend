/**
 * Unit tests for walletPortfolioV22Adapter.ts
 *
...
describe("walletPortfolioV22Adapter", () => {
  describe("transformToV22Data", () => {
    it("should transform complete landing page data correctly", () => {
      ...
      const result = transformToV22Data(landingData, sentimentData);
    ...
    it("should handle missing sentiment data with defaults", () => {
      ...
      const result = transformToV22Data(landingData, null);
    ...
    it("should handle empty portfolio correctly", () => {
      ...
      const result = transformToV22Data(landingData);
    ...
    it("should handle different regime ranges correctly", () => {
      ...
      const extremeFearResult = transformToV22Data(baseLandingData, {
        value: 20,
        status: "Extreme Fear",
        timestamp: "2025-01-01T00:00:00Z",
      ...
      const extremeGreedResult = transformToV22Data(baseLandingData, {
        value: 85,
  ...
  describe("createV22LoadingState", () => {
  ...
  describe("createV22ErrorState", () => {
    it("should create correct error state", () => {
      const errorState = createV22ErrorState();
